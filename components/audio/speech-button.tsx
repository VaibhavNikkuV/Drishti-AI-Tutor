      ...
      <TooltipTrigger asChild>
        <button
          ...
          className={cn(
            ...
            sizeClasses,
            active
              ? 'bg-blue-500/90 dark:bg-blue-600/80 text-white shadow-[0_0_12px_rgba(62, 103, 190,0.45)] dark:shadow-[0_0_12px_rgba(62, 103, 190,0.3)]'
        ...
        >
          ...
          {isRecording && (
            <span
              className="absolute inset-[-4px] rounded-[10px] border border-blue-400/40 dark:border-blue-400/25"
              style={{
