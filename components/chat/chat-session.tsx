          ...
          return (
            <motion.div
              ...
              animate={
                isActiveBubble
                  ? {
                      ...
                      y: 0,
                      boxShadow: [
                        '0 0 0 0 rgba(62, 103, 190, 0)',
                        '0 0 20px 0 rgba(62, 103, 190, 0.15)',
                        '0 0 8px 0 rgba(62, 103, 190, 0.08)',
                      ],
                    }
                  : {
                      opacity: 1,
                      y: 0,
                      boxShadow: '0 0 0 0 rgba(62, 103, 190, 0)',
                    }
              }
              transition={
                isActiveBubble
              ...
              className={cn(
                ...
                isActiveBubble &&
                  'border-l-blue-500 dark:border-l-blue-400 bg-blue-50/50 dark:bg-blue-900/20',
              )}
            >
              {/* Mini Avatar */}
